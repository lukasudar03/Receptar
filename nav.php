    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="index.php">Početna</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="RegistrationMode.php">Pretraga</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="Login&Registration.php">Login</a>
                </li>
            </ul>
        </div>
    </div>
